...
if "start_exercise_clicked" in st.session_state:
    print("yeah let's start exercise")  # Debugging line
    st.write("Starting exercise...")  # Debugging line
    user_input = "Let's start the practice exercise."
...
if "messages" in st.session_state and len(st.session_state.messages) > 0:
    ...
    start_exercise = st.button("Start Exercise", key="start_exercise_btn", on_click=start_exercise)